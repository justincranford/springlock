...
/** Functional + concurrency + perf tests: postgres:15.17 + JDBC optimistic strategy. */
@Tag("integration")
@Testcontainers
...
class LockServicePostgres15JdbcOptimisticIT extends AbstractLockServiceIT {
    ...
    @Override
    protected String backendLabel() { return "postgres15-jdbc-optimistic"; }
}
