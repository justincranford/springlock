...
/** Functional + concurrency + perf tests: postgres:15.17 + JPA strategy. */
@Tag("integration")
@Testcontainers
@ActiveProfiles("postgres")
class LockServicePostgres15JpaIT extends AbstractLockServiceIT {
    ...
    @Override
    protected String backendLabel() { return "postgres15-jpa"; }
}
