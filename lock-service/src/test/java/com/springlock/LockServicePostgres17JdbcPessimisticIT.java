...
/** Functional + concurrency + perf tests: postgres:17.9 + JDBC pessimistic strategy. */
@Tag("integration")
@Testcontainers
...
class LockServicePostgres17JdbcPessimisticIT extends AbstractLockServiceIT {
    ...
    @Override
    protected String backendLabel() { return "postgres17-jdbc-pessimistic"; }
}
