...
/** Functional + concurrency + perf tests: Citus (pg17) + JDBC pessimistic strategy. */
@Tag("integration")
@Testcontainers
...
class LockServiceCitusJdbcPessimisticIT extends AbstractLockServiceIT {
    ...
    @Override
    protected String backendLabel() { return "citus-jdbc-pessimistic"; }
}
