...
/** Functional + concurrency + perf tests: postgres:18.3 + JDBC optimistic strategy. */
@Tag("integration")
@Testcontainers
...
class LockServicePostgres18JdbcOptimisticIT extends AbstractLockServiceIT {
    ...
    @Override
    protected String backendLabel() { return "postgres18-jdbc-optimistic"; }
}
