...
/** Functional + concurrency + perf tests: postgres:16.13 + JDBC pessimistic strategy. */
@Tag("integration")
@Testcontainers
...
class LockServicePostgres16JdbcPessimisticIT extends AbstractLockServiceIT {
    ...
    @Override
    protected String backendLabel() { return "postgres16-jdbc-pessimistic"; }
}
