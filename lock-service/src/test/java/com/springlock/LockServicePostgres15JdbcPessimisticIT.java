...
/** Functional + concurrency + perf tests: postgres:15.17 + JDBC pessimistic strategy. */
@Tag("integration")
@Testcontainers
...
class LockServicePostgres15JdbcPessimisticIT extends AbstractLockServiceIT {

    static final String IMAGE = "postgres:15.17";
    ...
    @Override
    protected String backendLabel() { return "postgres15-jdbc-pessimistic"; }
}
