...
/** Functional + concurrency + perf tests: postgres:14.22 + JDBC optimistic strategy. */
@Tag("integration")
@Testcontainers
...
class LockServicePostgres14JdbcOptimisticIT extends AbstractLockServiceIT {
    ...
    @Override
    protected String backendLabel() { return "postgres14-jdbc-optimistic"; }
}
